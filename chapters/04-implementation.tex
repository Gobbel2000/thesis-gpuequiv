...
%TODO: Code example: Minimizing energies
...
As touched on in Chapter~\ref{ch:gpu}, %TODO: more precise reference when written
...
%TODO: Maybe code examples out of shader: energy_eq, less_eq, unpack, pack
...
%TODO: Note about support for other energy configurations
...
for example the \emph{Hornet} data structure by
F. Busato et al.~\cite{Busato2018}.
...
is limited to $2^{31} - 1 = 2\,147\,483\,647$ bytes,
