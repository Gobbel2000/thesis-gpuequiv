...
\subsection{Storing Energy Sets}
...
% Maybe code examples out of shader: energy_eq, less_eq, unpack, pack
...
% Collecting input data for shader invocation

\section{Limitations}

% Hardware:
    % Process only as many positions as fits
    % Maximum graph size
% What is done outside the shaders and why
% Attempting to generate the game graph on GPU
